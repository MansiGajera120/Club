...
export const verificationEmail = ({ name, verifyUrl }) => {
  ...
  const bodyHtml = `
    ...
    <p style="margin:0 0 8px;color:#6B7280;font-size:15px;line-height:1.65;">
      Thanks for signing up to <strong style="color:#111827;">ClubHub</strong>.
    ...
    <div style="background:#F1F5F9;border-radius:10px;padding:14px 16px;border:1px solid #E2E8F0;">
      ...
      <a href="${verifyUrl}" style="color:#2563EB;font-size:12px;word-break:break-all;text-decoration:none;">${verifyUrl}</a>
    </div>`;
