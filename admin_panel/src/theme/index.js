...
export function getTheme(mode) {
  ...
  return createTheme({
    ...
    typography: {
      ...
      h4: { fontFamily: 'Outfit, sans-serif', fontSize: '1.25rem', fontWeight: 700, lineHeight: 1.3, letterSpacing: '-0.01em' },
      h5: { fontFamily: 'Outfit, sans-serif', fontSize: '1.125rem', fontWeight: 600, lineHeight: 1.4 },
      h6: { fontFamily: 'Outfit, sans-serif', fontSize: '1rem', fontWeight: 600, lineHeight: 1.4 },
